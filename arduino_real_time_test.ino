...
#define MPU1_ADDR 0x68  // First MPU-6500 address
#define MPU2_ADDR 0x69  // Second MPU-6500 address
...
void loop() {
    ...
    ax1 -= ax1_offset;
    ay1 -= ay1_offset;
    az1 -= (az1_offset - 1.00); // Subtract 1g (gravity)
    
    ax2 -= ax2_offset;
    ay2 -= ay2_offset;
    az2 -= (az2_offset - 1.00); // Subtract 1g (gravity)
